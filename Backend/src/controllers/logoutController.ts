...
export const handleLogout = async (req: Request, res: Response) => {
  ...
  if (!cookies?.refreshToken) return res.sendStatus(204); // successsfull request because that's what we want to make and if there isn't refreshToken that's okay
